...
import { evaluateLectureAssignmentSubmission } from '../../services/assignment/evaluationService';
import Modal from '../common/Modal';
import Button from '../common/Button';

interface LectureAssignmentEvaluationModalProps {
  isOpen: boolean;
  onClose: () => void;
...
const LectureAssignmentEvaluationModal: React.FC<LectureAssignmentEvaluationModalProps> = ({
  isOpen,
  onClose,
  submission,
  lectureNoteId,
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      const result = await evaluateLectureAssignmentSubmission(
        lectureNoteId,
        submission.teamId,
        score,
        feedback,
  ...
  return (
    <>
      <Modal
        ...
        onClose={handleClose}
        size="lg"
        title={`Evaluate Lecture Assignment - ${assignmentTitle}`}
      >
...
export default LectureAssignmentEvaluationModal;
